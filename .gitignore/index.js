...
if (message.channel.type == "dm") return;
    ...
    const Link = ["https","http","NIGGA","phx","Phantom","Paragon","Impulse","dick","cock","cunt","nigga","nigger","shit","biatch","bitch","feck","homo","bastard","f u c k e r","f u c k","ejacu","d1ck","anus"];
